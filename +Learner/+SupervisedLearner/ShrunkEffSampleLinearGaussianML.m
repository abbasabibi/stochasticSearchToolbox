classdef ShrunkEffSampleLinearGaussianML < Learner.SupervisedLearner.LinearFeatureFunctionMLLearner
    ...
    methods
        ...
        function obj = ShrunkEffSampleLinearGaussianML(dataManager, linearfunctionApproximator, varargin)
