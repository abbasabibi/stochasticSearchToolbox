classdef ShrunkLinearGaussianMLLearner < Learner.SupervisedLearner.LinearFeatureFunctionMLLearner
    ...
    methods
        ...
        function obj = ShrunkLinearGaussianMLLearner(dataManager, linearfunctionApproximator, varargin)
       ...
       function [] = initCMApara(obj)
        ...
        function [sv, lambda] = varshrink (obj,inputData,x,weights)
            ...
            denominator = sum((v-vtarget).^2);
            lambda = numerator/denominator;
            lambda = min(lambda, minTerm); lambda = max(lambda, 0);
