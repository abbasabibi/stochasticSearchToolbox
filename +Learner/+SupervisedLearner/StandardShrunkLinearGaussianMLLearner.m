classdef StandardShrunkLinearGaussianMLLearner < Learner.SupervisedLearner.LinearFeatureFunctionMLLearner
    ...
    methods
        ...
        function obj = StandardShrunkLinearGaussianMLLearner(dataManager, linearfunctionApproximator, varargin)
