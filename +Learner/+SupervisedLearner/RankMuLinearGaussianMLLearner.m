classdef RankMuLinearGaussianMLLearner < Learner.SupervisedLearner.LinearGaussianMLLearner
    ...
    % Class methods
    methods
        function obj = RankMuLinearGaussianMLLearner(dataManager, linearfunctionApproximator, varargin)
