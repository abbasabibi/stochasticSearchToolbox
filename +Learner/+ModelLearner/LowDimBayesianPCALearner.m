...
classdef LowDimBayesianPCALearner < Learner.SupervisedLearner.SupervisedLearner
    ...
    % Class methods
    methods
        function obj = LowDimBayesianPCALearner(dataManager, linearfunctionApproximator, varargin)
        ...
        function W = RandomProj(obj, desiredDim, currentDim)
            ...
            W= randn (desiredDim , currentDim)*0.05+obj.PCAProj;
        end
        ...
        function [] = learnFunction(obj, inputData, outputData)
           ...
           stdOutput = ones(1,size(outputData,2));
            ...
            [ obj.PCAProj ]  = (pcaX( : , 1:obj.numPara))' ;
