...
classdef ContextualLowDimBayesianLearner < Learner.SupervisedLearner.SupervisedLearner
    ...
    % Class methods
    methods
        function obj = ContextualLowDimBayesianLearner(dataManager, linearfunctionApproximator, varargin)
