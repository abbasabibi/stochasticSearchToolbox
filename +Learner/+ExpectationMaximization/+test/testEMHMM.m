...
settings.setProperty('doKMeansInit', true);
settings.setProperty('keepOptionsShape', false);
...
dataManager.setRange('states', min(samples(:,1)), max(samples(:,1)));
dataManager.setRange('actions', min(samples(:,2)), max(samples(:,2)));
