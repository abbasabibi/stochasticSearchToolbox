...
if ~exist('ouput_data_name','var')
    output_data_name = 'thetaNoisyWindows';
end
...
settings.setProperty([gkkfLearnerName '_conditionalOperatorType'], 'reg');
...
settings.setProperty('stateKRS_validityDataEntry', 'thetaNoisyWindowsValid');
settings.setProperty('obsKRS_inputDataEntry', obs_feature_name);
settings.setProperty('obsKRS_validityDataEntry', 'thetaNoisyWindowsValid');
settings.setProperty('reducedKRS_inputDataEntry', feature_name);
settings.setProperty('reducedKRS_validityDataEntry', 'thetaNoisyWindowsValid');

gkkfLearner = Filter.Learner.GeneralizedKernelKalmanFilterLearner(dataManager,'gkkfLearner');