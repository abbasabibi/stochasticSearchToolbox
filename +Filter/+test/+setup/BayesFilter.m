...
kbfLearnerName = 'kbfLearner';
settings.setProperty([kbfLearnerName '_outputDataName'], output_data_name);
settings.setProperty([kbfLearnerName '_stateFeatureName'], feature_name);
settings.setProperty([kbfLearnerName '_obsFeatureName'], obs_feature_name);
settings.setProperty([kbfLearnerName '_observations'], {obs_feature_name, 'obsPoints'});
settings.setProperty([kbfLearnerName '_stateFeatureSize'], num_features);% pca_features);
settings.setProperty([kbfLearnerName '_obsFeatureSize'], num_obs_features);
settings.setProperty([kbfLearnerName '_stateKernelType'], state_kernel_type);
settings.setProperty([kbfLearnerName '_obsKernelType'], obs_kernel_type);
settings.setProperty([kbfLearnerName '_conditionalOperatorType'], cond_operator_type);
settings.setProperty([kbfLearnerName '_referenceSetLearnerType'], refset_learner_type);
...
settings.setProperty([kbfLearnerName '_windowPrediction'],window_prediction);
kbfLearner = Filter.Learner.KernelBayesFilterLearner(dataManager,kbfLearnerName);