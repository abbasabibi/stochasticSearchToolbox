classdef WindowPredictionRegGeneralizedKernelKalmanFilter < Filter.RegGeneralizedKernelKalmanFilter
    ...
    methods
        function obj = WindowPredictionRegGeneralizedKernelKalmanFilter(dataManager, winKernelReferenceSet, obsKernelReferenceSet, varargin)
            obj = obj@Filter.RegGeneralizedKernelKalmanFilter(dataManager, winKernelReferenceSet, obsKernelReferenceSet, varargin{:});
