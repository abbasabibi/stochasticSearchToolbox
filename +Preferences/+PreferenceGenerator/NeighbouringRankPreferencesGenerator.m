classdef NeighbouringRankPreferencesGenerator < Preferences.PreferenceGenerator.AbstractPreferenceGenerator
    
    methods
        
        function obj =  NeighbouringRankPreferencesGenerator(dataManager,calculateGlobal,rankVariable)
