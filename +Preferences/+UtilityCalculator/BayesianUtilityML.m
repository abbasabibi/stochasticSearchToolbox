classdef BayesianUtilityML < Preferences.UtilityCalculator.AbstractUtilityFunctionCalculator
    ...
    methods
        function obj =  BayesianUtilityML(dataManager,featureName,varargin)
