classdef BayesPreferenceSolver
    ...
    methods
        function obj = BayesPreferenceSolver(cholPrior,sampleCount,shapeM,use01LL)
        ...
        function p = dataLogLL(obj,theta,dif,importance)
            difValues = theta*(dif)';
        ...
        function [theta, logL] = solve(obj,thetaI,pref,dom,importance)                                    
            ...
            for i=1:obj.sampleCount
                [thetaI, logLI] = obj.elliptical_slice(thetaI, obj.cholPrior, @obj.dataLogLL, logLI, [], dif, importance);
                theta(i,:) = thetaI;
                logL(i,:) = logLI;
            end
        end
