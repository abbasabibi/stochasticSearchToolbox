classdef BayesianUtilityCompact < Preferences.UtilityCalculator.AbstractUtilityFunctionCalculator
    ...
    methods
        function obj =  BayesianUtilityCompact(dataManager,featureName,varargin)
