classdef EnvironmentSequentialOptionsTest < Data.DataManipulator
   ...
   methods
       function obj =  EnvironmentSequentialOptionsTest(dataManager1, dataManager2)
            ...
            obj.addDataManipulationFunction('sampleTermination', {'states', 'oldOptions'}, {'terminations'});
            obj.addDataManipulationFunction('sampleOption', {'states', 'oldOptions', 'terminations', 'timeSteps'}, {'newOptions'});
            
            
       end
   
       function [terminations] = sampleTermination(obj, states, oldOptions)
           terminations = round(rand(size(states,1), 1));
       end
       
       function [newOptions] = sampleOption(obj, states, oldOptions, terminations, timeSteps)
           newOptions = oldOptions;
           newOptions(logical(terminations)) = timeSteps(logical(terminations));
       end
