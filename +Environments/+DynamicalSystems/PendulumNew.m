classdef PendulumNew < Environments.DynamicalSystems.ContinuousTimeDynamicalSystem & Environments.Misc.PlanarForwardKinematics
    ...
    methods
        function obj = PendulumNew(sampler, isPeriodic)
            ...
            obj.dataManager.setRestrictToRange('actions', false);
