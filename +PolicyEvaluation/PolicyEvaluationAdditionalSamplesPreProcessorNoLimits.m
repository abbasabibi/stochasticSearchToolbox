classdef PolicyEvaluationAdditionalSamplesPreProcessorNoLimits < PolicyEvaluation.PolicyEvaluationPreProcessor
    ...
    methods (Static)
        function obj = CreateFromTrial(trial)
            ...
            obj = PolicyEvaluation.PolicyEvaluationAdditionalSamplesPreProcessorNoLimits(trial.dataManager, trial.policyEvaluationLearner, trial.policyEvaluationFunction, trial.actionPolicy);
    ...
    methods
        %%
        function obj = PolicyEvaluationAdditionalSamplesPreProcessorNoLimits(dataManager, policyEvaluationLearner, valueFunction, actionPolicy)
