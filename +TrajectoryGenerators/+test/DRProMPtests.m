...
imitationLearner.SubSamplingFactor=1;
imitationLearner.EMiterations=20;
imitationLearner.trajectoryGenerator.ComputeLikelihood=1;
...
%imitationLearnerTrajectory.updateModel(trData);
