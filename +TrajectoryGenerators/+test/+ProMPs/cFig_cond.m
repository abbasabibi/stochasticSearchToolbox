...
settings.setProperty('widthFactorBasis', 1.1);
settings.setProperty('Noise_std', 5);
...
%%% From file
load('+TrajectoryGenerators/+test/+ProMPs/data/im_data_opt.mat'  )
...
trajectoryGenerator.conditionTrajectory(0.25, -0.5, 1e-6, [1 0]);
