...
%%
configuredLearner = Experiments.Learner.BanditLearnedRewardModelLearningSetupPCA('REPSLearnedRewardPCARewardNoiseBayesPara');
...
standard = Experiments.Evaluation(...
    ...
    'settings.rewardNoiseMult','settings.bayesNoiseSigma','settings.maxSamples','settings.epsilonAction' },{...
    10,100,1.0, 0.05, 1000,0,1,100,0.5; ...
    },numIterations,numTrials);


variablesRewardNoise = Experiments.Evaluation(...
...
evaluate = Experiments.Evaluation.getCartesianProductOf([standard,variablesRewardNoise,variablesBayesParametersSigma,learner ]);
