...
REPSLearnedRewardNoiseParametersSigmaCor     =['/home/abdolmaleki/policysearchtoolbox/+Experiments/data/test/QuadraticBandit_REPSLearnedRewardNoiseParametersSigmaCor/numSamples_201405091927_01/experiment.mat']
...
StandardREPSMaxSamplesEpsilonActionCorVarRewardNoiseMult = ['/home/abdolmaleki/policysearchtoolbox/+Experiments/data/test/QuadraticBandit_REPSMaxSamplesEpsilonActionCorVarRewardNoiseMult/numSamples_201405091947_01/experiment.mat']
...
PCAbayesParamRewardNoise = ['/home/abdolmaleki/policysearchtoolbox/+Experiments/data/test/QuadraticBandit_REPSLearnedRewardPCARewardNoiseBayesPara/numSamples_201405112047_01/experiment.mat']
%% REPSLearnedRewardNoiseParametersSigmaCor
% load(REPSLearnedRewardNoiseMultParametersSigmaCor)
% labelProperty = {'settings.rewardNoiseMult', 'settings.bayesParametersSigma'} ;
% labelGenerator = @(x_, y_) sprintf('rewardNoiseMult %f, bayesParametersSigma %f', x_, y_);

% 
load(PCAbayesParamRewardNoise)
labelProperty = {'settings.rewardNoise', 'settings.bayesParametersSigma'} ;
labelGenerator = @(x_, y_) sprintf('rewardNoise %f, bayesParametersSigma %f', x_, y_);
...
%% CONSTANT bayesParametersSigma
%   plotName = 'REPSLearnedRewardNoiseMultVarKL' ;
%   evalIdx = [1:4] ;
