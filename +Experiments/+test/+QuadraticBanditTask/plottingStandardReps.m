...
load(StandardREPSMaxSamplesEpsilonActionCorVarRewardNoiseMult)
labelProperty = {'settings.maxSamples', 'settings.epsilonAction'} ;
labelGenerator = @(x_, y_) sprintf('maxSamples%f, settings.epsilonAction %f', x_, y_);

% 
% load(StandardREPSMaxSamplesEpsilonActionCorVarRewardNoise)
% labelProperty = {'settings.maxSamples', 'settings.epsilonAction'} ;
% labelGenerator = @(x_, y_) sprintf('maxSamples %f, settings.epsilonAction %f', x_, y_);
...
%% CONSTANT settings.epsilonAction
