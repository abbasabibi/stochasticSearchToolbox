...
% load(PowerTemperatureRewardNoiseMult)
% labelProperty = {'settings.rewardNoiseMult', 'setting.temperatureScalingPower'} ;
% labelGenerator = @(x_, y_) sprintf('rewardNoiseMult %f, temperatureScalingPower %f', x_, y_);

% 
load(PowerTemperatureRewardNoise)
labelProperty = {'settings.rewardNoise', 'setting.temperatureScalingPower'} ;
labelGenerator = @(x_, y_) sprintf('rewardNoise %f, temperatureScalingPower %f', x_, y_);
