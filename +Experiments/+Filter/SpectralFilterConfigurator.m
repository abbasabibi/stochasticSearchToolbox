classdef SpectralFilterConfigurator < Experiments.Configurator
    ...
    methods
        function obj = SpectralFilterConfigurator(name)
...
%             trial.bandwidthSelector.kernelMedianBandwidthFactor = .1;
            ...
            trial.setprop('filterOptimizer', Filter.Learner.SpectralFilterOptimizer(trial.dataManager, trial.filterLearner));
        end
