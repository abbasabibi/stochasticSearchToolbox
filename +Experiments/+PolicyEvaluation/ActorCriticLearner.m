classdef ActorCriticLearner < Experiments.Configurator
    
    methods
        function obj = ActorCriticLearner(learnerName)
        ...
        function preConfigureTrial(obj, trial)
            ...
            trial.setprop('actorUpdater', @Learner.ActorCritic.REPSStateActionDistribution.CreateFromTrial);
        end
