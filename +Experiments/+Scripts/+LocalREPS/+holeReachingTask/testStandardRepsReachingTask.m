...
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardRepsReachingTaskDiffMaxSamples');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.maxSamples'},{500,750,1000,1250},numIterations,numTrials);
