...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('localRepsTwoContextDiffBandwidth');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.bandwidthFactor'},{0.25,0.5,1,2,10,100},numIterations,numTrials);
