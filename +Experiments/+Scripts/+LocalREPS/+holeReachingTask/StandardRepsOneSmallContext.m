...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardRepsOneSmallContext');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.maxSamples'},{500},numIterations,numTrials);
