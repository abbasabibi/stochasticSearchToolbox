...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('localRepsTwoContextDiffMaxSamples');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.maxSamples'},{250,500,750,1250},numIterations,numTrials);
