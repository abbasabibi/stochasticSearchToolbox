...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardRepsTwoContextDiffMaxSamples');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.maxSamples'},{250,500,750,1000},numIterations,numTrials);
