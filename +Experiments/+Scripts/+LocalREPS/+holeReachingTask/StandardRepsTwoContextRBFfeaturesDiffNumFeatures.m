...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardRepTwoContextRBFfeaturesDiffNumFeatures');
...
default.setDefaultParameter('settings.useholeRadiusContext',true);
...
default.setDefaultParameter('settings.rbfNumDimCenters', 2);
default.setDefaultParameter('useFeaturesForPolicy',true);
default.setDefaultParameter('featureFunction',@FeatureGenerators.RBF.RadialFeatures);


evaluate1 = Experiments.Evaluation(...
    {'settings.rbfNumDimCenters'},{2,3,4,5},numIterations,numTrials);
