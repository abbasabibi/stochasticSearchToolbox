...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSContextNoiseSigma');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.bayesNoiseSigma'},{10;1;0.1;0.01},numIterations,numTrials);
