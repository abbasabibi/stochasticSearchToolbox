...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSInitSigmaBestProjMat');
...
default.setDefaultParameter('rewardFunctionLearner', @Learner.ModelLearner.BestLowDimProjector);
default.setDefaultParameter('settings.rewardFunctionLearner', @Learner.ModelLearner.BestLowDimProjector);



evaluate2 = Experiments.Evaluation(...
    {'settings.initSigmaParameters'},{0.05},numIterations,numTrials);
