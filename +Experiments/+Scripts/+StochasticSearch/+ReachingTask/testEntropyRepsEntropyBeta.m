...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('EntropyREPSEEntropyBetaWithNoiseNewSetupFadingEpsilon1');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.entropyBetaDiscount'},{0.995;0.999},numIterations,numTrials);
