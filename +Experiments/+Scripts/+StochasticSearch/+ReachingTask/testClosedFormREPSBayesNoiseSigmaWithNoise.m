...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSBayesNoiseSigmaWithNoise');
...
evaluate5 = Experiments.Evaluation(...
    {'settings.bayesNoiseSigma'},{100;50;10;5;1;0.5;10^-1;10^-2},numIterations,numTrials);
