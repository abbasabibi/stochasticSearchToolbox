...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSContextNumPara');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.numPara'},{3;6;9;12},numIterations,numTrials);
