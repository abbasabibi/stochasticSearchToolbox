...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardREPSInitSigmaWithoutNoise');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.initSigmaParameters'},{0.01;0.025;0.05;0.1},numIterations,numTrials);
