...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardREPSContextDiffrentLambda');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.priorCovWeightParameters'},{0.0001;0.001;0.01;0.1},numIterations,numTrials);
