...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSContextUniformDistDiffBayesParameter');
...
default.setDefaultParameter('settings.numProjMat', 8000);
...
default.setDefaultParameter('settings.InitialContextDistributionType', 'Uniform'); %Uniform
default.setDefaultParameter('settings.InitialContextDistributionWidth', 0.4); %0.4



evaluate1 = Experiments.Evaluation(...
    {'settings.bayesParametersSigma'},{10;1;0.1;0.01},numIterations,numTrials);
