...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardREPSMaxSampleswithoutNoiseMorethan500');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.maxSamples'},{550,600,650,700,750,900,1000},numIterations,numTrials);
