...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSWithNoiseHighDim2');
...
%evaluationCriterion.setSaveNumDataPoints(0);
...
default.setDefaultParameter('settings.entropyBetaDiscount', 0.984);
 ...
 evaluate1 = Experiments.Evaluation(...
     {'settings.numPara'},{7},numIterations,numTrials);
