...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('StandardREPSEpsilonActionWithOutNoise');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.epsilonAction'},{0.3...,0.5,1,1.5,2,2.5
    }, numIterations,numTrials);
