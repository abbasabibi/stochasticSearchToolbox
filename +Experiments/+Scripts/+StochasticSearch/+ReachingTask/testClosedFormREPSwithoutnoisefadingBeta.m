...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSWithoutNoiseDiffrentEntropyBetaForNIPS');
...
default.setDefaultParameter('settings.numInitialSamplesEpisodes', 14);
...
default.setDefaultParameter('settings.bayesParametersSigma', 0.01);
...
evaluate1 = Experiments.Evaluation(...
    {'settings.entropyBeta'},{0;50;150;500},numIterations,numTrials);
