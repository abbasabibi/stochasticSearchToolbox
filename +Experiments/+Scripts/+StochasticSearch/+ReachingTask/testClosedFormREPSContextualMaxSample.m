...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSContextMaxSample');
...
evaluate1 = Experiments.Evaluation(...
    {'settings.maxSamples'},{150;250;300;400},numIterations,numTrials);
