...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('powerTempertureWithOutNoiseNewSetupWithPriorCov');
...
evaluate2 = Experiments.Evaluation(...
    {'settings.temperatureScalingPower'},{10},numIterations,numTrials);
