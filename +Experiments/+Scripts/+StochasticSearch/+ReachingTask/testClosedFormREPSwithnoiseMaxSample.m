...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSWithNoiseNewTaskSetup');
...
default.setDefaultParameter('settings.numProjMat', 4000);
default.setDefaultParameter('settings.bayesNoiseSigma',5);
