...
%%
configuredLearner = Experiments.Learner.TrajectoryBasedRewardModelLearningSetup('ClosedFormREPSBetaWithDiffrentNoiseEntropYBeta2.5');
...
default.setDefaultParameter('settings.bayesNoiseSigma',0.01);
default.setDefaultParameter('useVirtualSamples', false);
default.setDefaultParameter('settings.entropyBeta', 2.5);


evaluate1 = Experiments.Evaluation(...
    {'settings.viaPointNoise'},{0;0.05;0.1;0.15;0.2;0.3;0.4;0.5},numIterations,numTrials);
