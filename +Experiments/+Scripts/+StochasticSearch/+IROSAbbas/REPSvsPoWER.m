...
%%
configuredLearner = Experiments.Learner.BanditLearnedRewardModelLearningSetup('RepsVsPower');
...
default.setDefaultParameter('settings.numInitialSamplesEpisodes', 400);
default.setDefaultParameter('settings.maxSamples', 400);
