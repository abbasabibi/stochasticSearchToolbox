...
load('/home/abbas/Documents/stochasticsearch/policysearchtoolbox/+Experiments/data/test/Examples.StochasticSearch.Rosenbrock.CMAES_Sphere/settings001/experiment.mat')
a= experiment.evaluationCollections{1};
[~, plotDataCMAES] = a.plotResultsTrials(1,'avgReturns');

load('/home/abbas/Documents/stochasticsearch/policysearchtoolbox/+Experiments/data/test/Examples.StochasticSearch.Rosenbrock.REPS_Sphere/settings001/experiment.mat')
a= experiment.evaluationCollections{1};
[~, plotDataCECERREPS] = a.plotResultsTrials(1,'avgReturns');


load('/home/abbas/Documents/stochasticsearch/policysearchtoolbox/+Experiments/data/test/Examples.StochasticSearch.Rosenbrock.StandardREPS_Sphere/settings001/experiment.mat')
a= experiment.evaluationCollections{1};
...
Plotter.plot2svg('geccoSphere.svg', gcf);