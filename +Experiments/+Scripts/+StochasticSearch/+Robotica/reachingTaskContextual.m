...
%%
configuredLearner = Experiments.Learner.BanditLearningSetup('IROSHighDimReachingPower');
...
default.setDefaultParameter('settings.numInitialSamplesEpisodes', 40);
...
default.setDefaultParameter('settings.epsilonAction',1.0);
...
default.setDefaultParameter('settings.rbfBandwidth',[0.04]);
...
default.setDefaultParameter('settings.numJoints',20);
