...
configuredLearner = Experiments.Learner.BanditLearnedRewardModelLearningSetup('holereachingCMAES2');
...
default.setDefaultParameter('settings.entropyBetaDiscount', 0.9995);
...
evaluate1 = Experiments.Evaluation(...
    {'settings.entropyPerEffSample'},{0.005},numIterations,numTrials);
