...
evaluate3_base_value_grid2 = Experiments.Evaluation(...
    ...
    'maxNumberKernelSamples','settings.maxSizeReferenceSet','settings.nactions','numJoints',...
   ...
   false,...
    ...
    100,...
     ...
     6000,...
     6000,...
     [10,10],...%number of actions in discretization
      2,... % two joints
     [0.5 0],... %desired position
     0.5,... %init sigma actions
    %(dataManager, linearfunctionApproximator, varargin)
    },1,numTrials);

evaluate_temperatures=Experiments.Evaluation(...
    {'settings.invTemperature'},{3},numIterations,numTrials);
