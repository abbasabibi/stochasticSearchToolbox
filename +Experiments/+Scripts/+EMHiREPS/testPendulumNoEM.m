...
configuredPolicy            = Experiments.ActionPolicies.ActionMMConfigurator('MixtureModel');

configuredLearner           = Experiments.Learner.StepBasedActionHiREPS('HiREPS', configuredKernelFeatures.featureOutputName, false);
