...
settings = {0.3,10,10,1,3;0.2,10,10,1,3;0.1,10,10,1,3;0.4,10,10,1,3;0.5,10,10,1,3;};
...
%configuredUtilityFeatures = Experiments.Features.FeatureRBFKernelStatesPeriodicNew('states','Utility');
...
configuredPolicyEvaluation = Experiments.Preferences.StepAndPreferenceBasedLearningSetupPolicyEvaluation('PB',@Preferences.UtilityCalculator.BayesianUtility,true);%configuredUtilityFeatures.nextFeatureOutputName);
...
configuredActorCritic = EExperiments.Preferences.PrefActorCriticLearner('REPS');
...
experiment = Experiments.Experiment.createByNameNew(experimentName, category, ...
     {configuredTask, configuredFeatures, configuredActionFeatures, configuredUtilityFeatures, configuredQFunction, configuredPolicy, configuredNextStateStateActionFeatures, configuredPolicyEvaluation, configuredFeatureLearnerStatesActions, condiguredDensityPreprocessor, configuredActorCritic}, evaluationCriterion, 5, ...
    {'127.0.0.1',1});
