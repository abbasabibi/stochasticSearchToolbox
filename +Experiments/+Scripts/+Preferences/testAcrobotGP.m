...
evaluateMaxSamples = Experiments.Evaluation(...
    {'settings.maxSamples'},{200;},numIterations,numTrials);
...
experiment = Experiments.Experiment.createById('Experiment2', category, ...
...
experiment.setDefaultParameter('settings.maxSizeReferenceSet', 300); %600
