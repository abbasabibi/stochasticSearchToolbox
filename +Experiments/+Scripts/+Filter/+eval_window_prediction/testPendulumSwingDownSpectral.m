...
evaluate.setDefaultParameter('windowAliasAdderAliasTargets', {'thetaNoisyWindows','thetaNoisyWindows','thetaNoisyWindows','thetaWindows'});
evaluate.setDefaultParameter('windowAliasAdderAliasIndices', {1:4, 2:4+1, 3:4+2, 1:4});
