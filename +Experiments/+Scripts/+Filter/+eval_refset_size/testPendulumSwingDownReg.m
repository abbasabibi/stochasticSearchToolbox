...
%category = 'test';
experimentName = 'GkkfPendulumSwingDownReg';

% set some variables
redRefSizes = {100; 300; 500};
numIterations = 5;
numTrials = 20;
...
experiment = Experiments.Experiment.createById(experimentName, category, ...
     {configuredTask, configuredAliasAdder, configuredNoisePreprocessor, configuredWindowPreprocessor, configuredObservationPointsPreprocessor, configuredLinearTransformFeature, configuredFeatureLearner, configuredGkkf}, evaluationCriterion);
