...
%category = 'test';
experimentName = 'evalParameters_RedKernelSize';

% set some variables
redKernelSize = {400;500;600;700;800;900;1000;1100;1200;1300;1400};
numIterations = 1;
numTrials = 10;
...
evaluate = Experiments.Evaluation(...
    {'settings.reducedKRS_maxSizeReferenceSet'},redKernelSize,numIterations,numTrials);
...
evaluate.setDefaultParameter('settings.windowPreprocessor_windowSize', 8);
