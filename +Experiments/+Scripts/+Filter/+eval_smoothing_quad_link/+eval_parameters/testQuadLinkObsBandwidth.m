...
%category = 'test';
experimentName = 'evalParameters_ObsBandwidthFactor';

% set some variables
obsBandwidthFactor = {.1;.2;.3;.4;.5;.7:.8;.9;1};
numIterations = 1;
numTrials = 10;
...
evaluate = Experiments.Evaluation(...
    {'settings.obsKRS_kernelMedianBandwidthFactor'},obsBandwidthFactor,numIterations,numTrials);
