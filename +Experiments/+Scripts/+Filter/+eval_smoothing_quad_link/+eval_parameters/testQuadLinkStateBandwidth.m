...
%category = 'test';
experimentName = 'evalParameters_StateBandwidthFactor';

% set some variables
stateBandwidthFactor = {.5;.75;1;1.25;1.5};
numIterations = 1;
numTrials = 10;
...
evaluate = Experiments.Evaluation(...
    {'settings.stateKRS_kernelMedianBandwidthFactor'},stateBandwidthFactor,numIterations,numTrials);
