...
evaluate.setDefaultParameter('settings.filterLearner_featureName', 'theta');
evaluate.setDefaultParameter('settings.filterLearner_observations', {'theta', 'obsPoints'});
evaluate.setDefaultParameter('settings.filterLearner_featureSize', 1);% pca_features);
...
evaluate.setDefaultParameter('settings.kernelReferenceSet_inputDataEntry', 'theta');
evaluate.setDefaultParameter('settings.kernelReferenceSet_validityDataEntry', 'thetaWindowsValid');

% optimization settings
evaluate.setDefaultParameter('settings.ceokkfOptimizer_inputDataEntry','theta');
...
evaluate.setDefaultParameter('evaluationObservations','theta');
