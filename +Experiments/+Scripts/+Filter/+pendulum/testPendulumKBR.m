...
evaluate.setDefaultParameter('settings.GKKF_kappa',exp(-11));
evaluate.setDefaultParameter('settings.GKKF_lambdaO',exp(-6));
evaluate.setDefaultParameter('settings.GKKF_lambdaT',exp(-6));

evaluate.setDefaultParameter('settings.stateKRS_kernelMedianBandwidthFactor', 2.5);
evaluate.setDefaultParameter('settings.obsKRS_kernelMedianBandwidthFactor', 3);
...
evaluate.setDefaultParameter('settings.maxNumOptiIterationsGKKF_CMAES_optimization', 30);
