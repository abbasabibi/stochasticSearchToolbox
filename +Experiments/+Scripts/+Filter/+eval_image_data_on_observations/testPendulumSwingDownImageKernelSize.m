...
%category = 'test';
experimentName = 'kernel_size';

% set some variables
redRefSizes = {400; 600; 800; 1000; 1200};
numIterations = 3;
numTrials = 8;
...
evaluate.setDefaultParameter('settings.ParameterMapGKKF_CMAES_optimization',[true(1,20) true true true]);
