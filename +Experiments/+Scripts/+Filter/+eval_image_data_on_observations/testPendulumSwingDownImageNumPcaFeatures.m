...
%category = 'test';
experimentName = 'num_pca';

% set some variables
numPcaFeatures = { 5  8  3 15  5 ((1:5)+100)
                  10 15  5 30 10 ((1:10)+100)
                  15 23  8 45 15 ((1:15)+100)
                  20 30 10 60 20 ((1:20)+100)};
numIterations = 3;
numTrials = 8;
...
evaluate = Experiments.Evaluation(...
    {'stateNumFeatures' 'settings.stateKernel_numWindows' 'settings.obsKernel_numWindows' 'settings.filterLearner_stateFeatureSize' 'settings.filterLearner_obsFeatureSize' 'settings.GKKF_CMAES_optimization_observationIndex'},numPcaFeatures,numIterations,numTrials);
