...
category = 'evalImageDataOptOnObs';
%category = 'test';
...
filteredImageDataEvaluator.observationIndex = 1;
...
evaluate.setDefaultParameter('settings.observationPointsPreprocessor_observationIndices',[1:5,18:20]);
...
evaluate.setDefaultParameter('settings.spectralLearner_outputDataName', 'thetaNoisyPicture');

evaluate.setDefaultParameter('kernelType','WindowedExponentialQuadraticKernel');
% evaluate.setDefaultParameter('windowSize',20);
evaluate.setDefaultParameter('outputDims',100);
% evaluate.setDefaultParameter('settings.kernel_numWindows',4);
evaluate.setDefaultParameter('numEigenvectors',50);
...
evaluate.setDefaultParameter('settings.groundtruthName','thetaNoisyPicture');
evaluate.setDefaultParameter('settings.CMAOptimizerInitialRangeSpectral_CMAES_optimization', .1);
evaluate.setDefaultParameter('settings.maxNumOptiIterationsSpectral_CMAES_optimization', 150);

evaluate.setDefaultParameter('evaluationGroundtruth','thetaNoisyPicture');
