...
%category = 'test';
experimentName = 'window_size';

% set some variables
windowSizes = {2 2 10 20
               3 3 15 30
               4 4 20 40
               5 5 25 50
               6 6 30 60};
...
evaluate = Experiments.Evaluation(...
    {'settings.windowPreprocessor_windowSize' 'settings.windowPreprocessor_indexPoint' 'settings.stateKernel_numWindows' 'settings.filterLearner_stateFeatureSize'},windowSizes,numIterations,numTrials);
