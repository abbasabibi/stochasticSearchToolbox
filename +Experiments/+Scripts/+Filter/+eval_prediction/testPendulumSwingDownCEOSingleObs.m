...
category = 'evalPrediction';
%category = 'test';
experimentName = 'CeokkfPendulumSwingDownSingleObservation';
...
% evaluate.setDefaultParameter('stateFeaturesVariables', 'thetaNoisy');
...
evaluate.setDefaultParameter('settings.filterLearner_featureName', 'thetaNoisy');
...
evaluate.setDefaultParameter('settings.kernelReferenceSet_inputDataEntry', 'thetaNoisy');
evaluate.setDefaultParameter('settings.kernelReferenceSet_validityDataEntry', 'thetaNoisyWindowsValid');

% optimization settings
evaluate.setDefaultParameter('settings.ceokkfOptimizer_inputDataEntry','thetaNoisy');
