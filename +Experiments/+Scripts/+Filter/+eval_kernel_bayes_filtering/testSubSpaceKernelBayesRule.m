...
experimentName = 'subspaceKernelBayesRule';

% set some variables
kernelSizes = {50 50 50; 100 100 100; 250 250 100; 500 500 100};
numIterations = 3;
numTrials = 4;
...
evaluate = Experiments.Evaluation(...
    {'settings.stateKRS_maxSizeReferenceSet','settings.obsKRS_maxSizeReferenceSet','settings.reducedKRS_maxSizeReferenceSet'},kernelSizes,numIterations,numTrials);
