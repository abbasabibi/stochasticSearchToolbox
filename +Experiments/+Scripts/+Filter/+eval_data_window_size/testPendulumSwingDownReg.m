...
category = 'evalDataWindowSize';
%category = 'test';
experimentName = 'GkkfRegPendulumSwingDown';

% set some variables
window_size =  repmat({2; 4; 6; 8},1,3);
numIterations = 3;
numTrials = 20;
...
evaluate = Experiments.Evaluation(...
    {'settings.windowSize','settings.filterLearner_stateFeatureSize','settings.windowPreprocessor_windowSize'},window_size,numIterations,numTrials);
...
evaluate.setDefaultParameter('settings.numSamplesEpisodes',[10 20 20]);
