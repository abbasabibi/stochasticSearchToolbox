...
load('/home/yy05vipo/git/policysearchtoolbox/+Experiments/data/evalDoubleLinkWindowPrediction/DoubleLinkSwingDown_noisePreprocessorConfigurator_windowPreprocessorConfigurator_observationPointsPreprocessorConfigurator_gkkfConfigurator/GkkfRegDoubleLinkSwingDownLearnTCov_201502271428_01/experiment.mat')
learnTCovGkkfData = obj.getTrialData({'windowPredictionEvaluator'});

load('/home/yy05vipo/git/policysearchtoolbox/+Experiments/data/evalDoubleLinkWindowPrediction/DoubleLinkSwingDown_noisePreprocessorConfigurator_windowPreprocessorConfigurator_observationPointsPreprocessorConfigurator_ceokkfConfigurator/CeokkfDoubleLinkSwingDown_201502232232_01/experiment.mat')
ceoKkfData = obj.getTrialData({'windowPredictionEvaluator'});

load('/home/yy05vipo/git/policysearchtoolbox/+Experiments/data/evalDoubleLinkWindowPrediction/DoubleLinkSwingDown_noisePreprocessorConfigurator_windowPreprocessorConfigurator_windowAliasAdder_observationPointsPreprocessorConfigurator_spectralConfigurator/SpectralDoubleLinkSwingDown_201502210137_01/experiment.mat')
