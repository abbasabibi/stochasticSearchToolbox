...
load('/home/yy05vipo/git/policysearchtoolbox/+Experiments/data/evalBigRefsetSize/SwingDown_stateAliasAdder_noisePreprocessorConfigurator_windowPreprocessorConfigurator_observationPointsPreprocessorConfigurator_gkkfConfigurator/GkkfRegPendulumSwingDown_201502201113_01/experiment.mat')
...
[stdDataPlot] = Plotter.PlotterEvaluations.preparePlotData(stdGkkfData, 'iterations', 'filteredDataEvaluator', 'settings.stateKRS_inputDataEntry', @(x_) sprintf('features = %s', x_), ['evalBigReferenceSet_std'], false, [1 2], []);
[regDataPlot] = Plotter.PlotterEvaluations.preparePlotData(regGkkfData, 'iterations', 'filteredDataEvaluator', 'settings.stateKRS_inputDataEntry', @(x_) sprintf('features = %s', x_), ['evalBigReferenceSet_reg'], false, [1 2], []);
