classdef SwingUpTask < Experiments.Tasks.StepBasedTask
    ...
    methods
        function obj = SwingUpTask(isInfiniteHorizon)
        ...
        function preConfigureTrial(obj, trial)
            ...
            trial.setprop('rewardFunction', @RewardFunctions.QuadraticRewardFunction);
        end
