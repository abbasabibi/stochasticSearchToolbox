classdef RandomEventSwingTask < Experiments.Tasks.StepBasedTask
    ...
    methods
        function obj = RandomEventSwingTask(isInfiniteHorizon)
            obj = obj@Experiments.Tasks.StepBasedTask('RandomEventSwing', isInfiniteHorizon);
        end
        ...
        function setupEnvironment(obj, trial) 
            trial.transitionFunction = Environments.DynamicalSystems.RandomEventPendulum(trial.sampler, trial.isPeriodic);
