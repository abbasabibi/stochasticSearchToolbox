classdef SwingDownTask < Experiments.Tasks.StepBasedTask
    ...
    methods
        function obj = SwingDownTask(isInfiniteHorizon)
            obj = obj@Experiments.Tasks.StepBasedTask('SwingDown', isInfiniteHorizon);
        end
...
%             trial.dataManager.addDataEntry('contexts', 2, [-.25*pi, -2*pi], [.25*pi, 2*pi]);
