classdef StepBasedHiREPS < Experiments.ConfiguredLearner
...
%         isInitKMeans = false;
    ...
    methods
        function obj = StepBasedHiREPS(learnerName, modelFeatureName, usesEM)
...
%             trial.setprop('doKMeansInit', true);
            ...
            trial.setprop('modelLearner',...
                ...
                trial.dataManager, ':', trial.(obj.modelFeatureName), [], [], trial.sampler.stageSampler.isActiveSampler.resetProbName));
                        
            trial.setprop('learner',@(trial) ...
                Learner.SteadyStateRL.HiREPSIter(trial.dataManager, ...
                trial.parameterPolicyLearner, 'returns', 'returnWeightings','responsibilities', trial.(obj.modelFeatureName).outputName, trial.modelLearner.outputName));                        
