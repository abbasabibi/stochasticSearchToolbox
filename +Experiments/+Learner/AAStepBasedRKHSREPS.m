classdef AAStepBasedRKHSREPS < Experiments.Learner.StepBasedLearningSetup
    ...
    methods
        function obj = AAStepBasedRKHSREPS(learnerName)
        ...
        function preConfigureTrial(obj, trial)
            ...
            trial.setprop('rewardLearner',...
                @(trial) Learner.SupervisedLearner.KernelRegression(...
                trial.dataManager,trial.r_kernel, {{'states','actionsLinear'}}, 'rewards','RKHSparams_r'));
        ...
        function setupLearner(obj, trial)
            ...
            trial.rewardLearner= trial.rewardLearner(trial);
...
%             trial.scenario.addLearner(trial.policyFeatures);         
            ...
            trial.scenario.addLearner(trial.rewardLearner);           
