...
if strcmp(get(ax,'XTickLabelMode'),'auto') && strcmp(get(ax,'XScale'),'linear')
    ...
    if PLOT2SVG_globals.octave
        ...
        numlabelsChar = get(ax,'XTickLabel');
        if ~isempty(numlabelsChar)
            for i = 1:  size(numlabelsChar,1)
                numlabels(i) = str2double(numlabelsChar(i,:));
            end
        end
    end
...
if strcmp(get(ax,'YTickLabelMode'),'auto') && strcmp(get(ax,'YScale'),'linear')
    ...
    if PLOT2SVG_globals.octave
        ...
        numlabelsChar = get(ax,'YTickLabel');
        if ~isempty(numlabelsChar)
            for i = 1:  size(numlabelsChar,1)
                numlabels(i) = str2double(numlabelsChar(i,:));
            end
